...
const ContactSection = () => {
	...
	const handleSubmit = (e) => {
		e.preventDefault();
		const mailtoLink = `mailto:info@bf-netzbau.de?subject=Kontaktanfrage von ${name}&body=${encodeURIComponent(
			`Name: ${name}\nEmail: ${email}\n\nNachricht:\n${message}`
		)}`;
	...
	return (
		<section
			id="contact"
			className="py-20 px-6 bg-gradient-to-r from-[#7a0505] to-[#f51010]"
		>
			...
			<div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-12">
				...
				>
					<form className="space-y-6" onSubmit={handleSubmit}>
						<h3 className="text-2xl font-semibold text-[#e92b26] mb-6 text-center">
				...
				>
					<div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-shadow duration-300">
						<h3 className="text-2xl font-semibold text-[#e92b26] mb-6">
						...
						<div className="flex space-x-6 mt-6">
							<a
								href="#"
								className="text-[#44403d] hover:text-[#e92b26] transition-colors duration-300"
							>
