...
const FlyersSection = () => {
    const flyers = [
        { src: '/assets/images/flyer1.jpg', alt: 'Flyer 1' },
        { src: '/assets/images/flyer2.jpg', alt: 'Flyer 2' },
    ];
                ...
                >
                    {flyers.map((flyer, index) => (
                        <SwiperSlide key={index}>
                            <img src={flyer.src} alt={flyer.alt} className="rounded-lg shadow-lg w-full object-cover" />
                        </SwiperSlide>
                    ))}
                </Swiper>
            </div>
