	...
	return (
		...
		>
			...
			<div className="p-6 flex flex-col flex-grow">
				...
				<button className="w-fit mx-auto px-12 py-3 mt-auto flex items-center justify-center gap-2 bg-[#44403d] text-white rounded-lg transition-all duration-300 hover:bg-[#e92b26] hover:shadow-xl hover:px-20 focus:outline-none focus:ring-2 focus:ring-[#e92b26] focus:ring-opacity-50">
					<span>Weiter</span>
					<svg
						className="w-5 h-5"
						fill="none"
